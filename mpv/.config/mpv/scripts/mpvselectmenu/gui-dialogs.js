 ...
 *
 * This is intended to be used in concert with mpvselectmenu, but can be used seperately
...
function createDialog(selType, selMode) {
    ...
    // Convert newlines into record separators to unify KDialog and Zenity outputs.
