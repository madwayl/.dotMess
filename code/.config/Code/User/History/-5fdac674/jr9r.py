...
class NemoTerminal(object):
    ...
    def __init__(self, uri, window):
        ...
        palette = [
            ...
            # 8 - Dark Gray (Dimmed, used for background in some themes)
            Gdk.RGBA(0.36, 0.33, 0.31, 1.0),  # Dark Gray

            # 9 - Red 2 (Another shade of red)
            Gdk.RGBA(0.76, 0.22, 0.29, 1.0),  # Gruvbox Red 2

            # 10 - Green 2 (A variant of green)
            ...
            # 13 - Purple 2
            Gdk.RGBA(0.64, 0.45, 0.91, 1.0),  # Light Purple (alternate)
        ...
        self.term.set_colors( 
                        # Gdk.RGBA(0.98, 0.94, 0.93, 1.0),  # Light text
                        # Gdk.RGBA(0.18, 0.12, 0.18, 1.0),  # Dark background
                        palette)
