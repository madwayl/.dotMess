...
class NemoTerminal(object):
    ...
    def __init__(self, uri, window):
        ...
        palette = [
            # 0 - Black
            Gdk.RGBA(0.23, 0.22, 0.21, 1.0),  # #3c3836

            # 1 - Red
            Gdk.RGBA(0.80, 0.14, 0.11, 1.0),  # #cc241d

            # 2 - Green
            Gdk.RGBA(0.60, 0.60, 0.10, 1.0),  # #98971a

            # 3 - Yellow
            Gdk.RGBA(0.85, 0.60, 0.13, 1.0),  # #d79921

            # 4 - Blue
            Gdk.RGBA(0.27, 0.53, 0.53, 1.0),  # #458588

            # 5 - Purple
            Gdk.RGBA(0.69, 0.38, 0.52, 1.0),  # #b16286

            # 6 - Aqua
            Gdk.RGBA(0.41, 0.62, 0.42, 1.0),  # #689d6a

            # 7 - Light Gray (White in darker themes)
            Gdk.RGBA(0.66, 0.60, 0.52, 1.0),  # #a89984

            # 8 - Dark Gray
            Gdk.RGBA(0.57, 0.51, 0.45, 1.0),  # #928374

            # 9 - Red 2
            Gdk.RGBA(0.98, 0.29, 0.20, 1.0),  # #fb4934

            # 10 - Green 2
            Gdk.RGBA(0.72, 0.73, 0.15, 1.0),  # #b8bb26

            # 11 - Yellow 2
            Gdk.RGBA(0.98, 0.74, 0.19, 1.0),  # #fabd2f

            # 12 - Blue 2
            Gdk.RGBA(0.51, 0.65, 0.60, 1.0),  # #83a598

            # 13 - Purple 2
            Gdk.RGBA(0.82, 0.53, 0.61, 1.0),  # #d3869b

            # 14 - Aqua 2
            Gdk.RGBA(0.56, 0.75, 0.49, 1.0),  # #8ec07c

            # 15 - White
            Gdk.RGBA(0.98, 0.94, 0.78, 1.0)   # #fbf1c7
        ]

        self.term.set_colors(
                        # 15 - Beige
                        Gdk.RGBA(0.92, 0.86, 0.69, 1.0),     # White (for bright elements)
        ...
        self.term.set_color_highlight(Gdk.RGBA(0.7, 0.2, 0.1, 0.40))  # Less bright, slightly darker red, and lower opacity
