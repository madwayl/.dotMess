...
class NemoTerminal(object):
    ...
    def __init__(self, uri, window):
        ...
        palette = [
            Gdk.RGBA(0.86, 0.18, 0.23, 1.0),  # Red
            Gdk.RGBA(0.18, 0.78, 0.29, 1.0),  # Green
            Gdk.RGBA(0.88, 0.73, 0.27, 1.0),  # Yellow
            Gdk.RGBA(0.32, 0.42, 0.73, 1.0),  # Blue
            Gdk.RGBA(0.76, 0.47, 0.62, 1.0),  # Purple
            Gdk.RGBA(0.62, 0.61, 0.45, 1.0),  # Aqua
            Gdk.RGBA(0.82, 0.46, 0.26, 1.0),  # Orange
            Gdk.RGBA(0.89, 0.79, 0.58, 1.0),  # Light Gray
            Gdk.RGBA(0.36, 0.33, 0.31, 1.0),  # Dark Gray
            Gdk.RGBA(0.74, 0.56, 0.34, 1.0),  # Yellow 2
            Gdk.RGBA(0.76, 0.22, 0.29, 1.0),  # Red 2
            Gdk.RGBA(0.38, 0.60, 0.23, 1.0),  # Green 2
            Gdk.RGBA(0.61, 0.42, 0.85, 1.0),  # Blue 2
            Gdk.RGBA(0.92, 0.73, 0.25, 1.0),  # Orange 2
            Gdk.RGBA(0.98, 0.90, 0.32, 1.0),  # Light Yellow (added)
            Gdk.RGBA(0.64, 0.45, 0.91, 1.0)   # Light Purple (added)
        ]
